...
public class DBService {
	...
	public void instantiateTestBatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Naria Silva", "gabriel.xioso@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		
		Cliente cli2 = new Cliente(null, "Ana Silva", "gabriel.xioso@gmail.com", "78986589060",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("9999999", "9999999"));
		...
		Endereco e3 = new Endereco(null, "Rua Matos", "321", null, "ZL", "321456", cli2, c2);
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDETE, ped2, sdf.parse("20/10/2020 00:00"),
				null);
