...
public class DBService {
	...
	public void instantiateTestBatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Naria Silva", "maria@gmail.com", "36378912377", TipoCliente.PESSOAFISICA);
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDETE, ped2, sdf.parse("20/10/2020 00:00"), null);
